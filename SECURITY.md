...
You can also report vulnerabilities through [GitHub Security Advisories](https://github.com/Alexi5000/claude-code-templates/security/advisories/new) for this repository.
